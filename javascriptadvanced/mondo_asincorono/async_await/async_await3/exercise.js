/*In questo esercizio, come nel precendente andremo a simulare il caricamento di moduli di 
un veicolo spaziale in modo asincrono e quindi lanciare il veicolo spaziale quando tutti
...
che chiama in sequenza la funzione
"caricaModulo" per caricare i moduli A, B e C, attendendo il 
...
Alla fine, se tutti i moduli sono stati caricati con successo, stampa
in console "Veicolo spaziale pronto per il lancio!".*/
...
async function lanciaVeicoloSpaziale() {
    try {
        ...
        const moduloA = await caricaModulo();
        console.log("Modulo A");
        const moduloB = await caricaModulo();
        console.log("Modulo B");
        const moduloC = await caricaModulo();
